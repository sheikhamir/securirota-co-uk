...
-- Insert initial test data to verify the migration (using existing user ID)
INSERT INTO activity_log (user_id, action_type, entity_type, entity_id, description, ip_address) 
VALUES (7, 'update_shift', 'system', NULL, 'Database migration completed - added reschedule functionality and activity logging', '127.0.0.1');
