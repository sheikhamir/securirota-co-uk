...
<head>
    ...
    <title>Subscription Tier Management - ROOT CONTROL</title>
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Manage subscription plans, pricing, and features</p>
                    </div>
                    <div>
            ...
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h5 class="modal-title" id="editTierModalLabel">
                        <i class="fas fa-edit me-2"></i>Edit Subscription Tier
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <form method="POST" action="subscription_tiers.php">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="edit_is_custom" name="is_custom">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="edit_max_officers" name="max_officers" min="1" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="edit_max_sites" class="form-label">Max Sites</label>
                                    <input type="number" class="form-control" id="edit_max_sites" name="max_sites" min="1" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="edit_max_clients" class="form-label">Max Clients</label>
                                    <input type="number" class="form-control" id="edit_max_clients" name="max_clients" min="1" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="edit_monthly_price" name="monthly_price" min="0" step="0.01" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="edit_yearly_price" class="form-label">Yearly Price (£)</label>
                                    <input type="number" class="form-control" id="edit_yearly_price" name="yearly_price" min="0" step="0.01" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Features</label>
                            <div class="row" id="edit_features_container">
                                <?php foreach ($available_features as $key => $label): ?>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="edit_feature_<?php echo $key; ?>" name="features[<?php echo $key; ?>]">
                                            <label class="form-check-label" for="edit_feature_<?php echo $key; ?>">
                                                <?php echo $label; ?>
                                            </label>
                                        </div>
                                    </div>
            ...
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteTierModalLabel">
                        <i class="fas fa-trash me-2 text-danger"></i>Delete Subscription Tier
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <form method="POST" action="subscription_tiers.php">
                    <div class="modal-body">
                        ...
                        <p>Are you sure you want to delete the subscription tier <strong id="delete_tier_name"></strong>?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Edit tier modal
            document.querySelectorAll('.edit-tier-btn').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    var tier = JSON.parse(this.getAttribute('data-tier'));
                    ...
                    document.querySelectorAll('#edit_features_container input[type="checkbox"]').forEach(function(checkbox) {
                        checkbox.checked = false;
                    });
                    
                    // Set features
                    if (tier.features) {
                        var features = JSON.parse(tier.features);
                        features.forEach(function(feature) {
                            var checkbox = document.getElementById('edit_feature_' + feature);
                            if (checkbox) {
            ...
            // Delete tier modal
            document.querySelectorAll('.delete-tier-btn').forEach(function(btn) {
                btn.addEventListener('click', function() {
